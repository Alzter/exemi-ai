...
### 1. Install Meta Llama 3.1 with Ollama
...
To install the LLM, run this command within the root directory of the repository:
...
### 3. Create Exemi database and database administrator account
...
### 4. Create a user token encryption key
...
### 5. Create an .env file to store the secrets
