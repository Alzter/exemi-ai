...
import ConfigureUniversities from "./uni_aliases";
        ...
        return (
            <div>
                <Routes>
                  ...
                  <Route path="universities/" element={<ConfigureUniversities session={session}/>}/>
                  <Route path="uni_aliases/" element={<ConfigureUniversities session={session}/>}/>
